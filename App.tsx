...
const AppContent: React.FC = () => {
  ...
  const appSections = [
    ...
    { title: 'Studio & Edit', apps: filteredAppsMetadata.filter(a => !favoriteApps.has(a.id) && [AppId.GUBER_EDIT, AppId.GUBER_TYPO, AppId.GUBER_CLEAN, AppId.GUBER_ERASER, AppId.GUBER_UPSCALE, AppId.GUBER_RESTORE, AppId.GUBER_LATAR, AppId.GUBER_CROP, AppId.GUBER_SS_VIDEO, AppId.GUBER_UBAH, AppId.GUBER_LUAS, AppId.GUBER_WATERMARK, AppId.COLOR_PICKER].includes(a.id)) },
