  ...
  const handleGenerate = async () => {
    ...
    try {
      const updatedConfig: SepatuConfig = { 
        ...
        logo: activeTab === 'SHOWROOM' ? (logoImage || undefined) : undefined,
        ...
        showroomAmbiance: activeTab === 'SHOWROOM' ? (config.showroomAmbiance || 'DEFAULT') : undefined,
        showroomColor: activeTab === 'SHOWROOM' ? (config.showroomColor || undefined) : undefined,
                ...
                {activeTab === 'SHOWROOM' ? (
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-slate-50 border-2 border-slate-100 rounded-2xl">
                      <h3 className="font-black text-slate-800 uppercase tracking-widest text-[9px] mb-2">POV Handheld Mode</h3>
                      <p className="text-[8px] font-medium text-slate-500 leading-relaxed uppercase tracking-wider">
                        Mode POV akan menghasilkan foto aesthetic seolah-olah anda sedang memegang sepatu tersebut di depan kamera.
                      </p>
                    </div>
                  </div>
                ) : (
