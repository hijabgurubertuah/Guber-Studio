  ...
  return runWithRetry(async (ai) => {
    ...
    if (config.mode === 'SHOWROOM') {
      ...
      prompt = `
        ...
        The input image is a product photo of a piece of footwear.
        Generate an ultra-realistic POV product photography shot of this EXACT footwear being held naturally by one hand.
        
        [CRITICAL REQUIREMENT]:
        - Preserve the EXACT original design, color, texture, shape, logo, stitching, and details of the uploaded footwear. 
        - The product must remain identical and highly recognizable. 
        - Hand should hold the footwear naturally.
        
        [SCENE & ENVIRONMENT]:
        - Background: ${povEnvironment}. Soft minimalist interior, luxury lifestyle aesthetic.
        - Lighting: Natural window lighting, bright soft shadows, cozy modern atmosphere.
        - Focus: Hand-held POV angle, the footwear is close to the camera and the main focus.
        - Composition: Background slightly blurred with realistic depth of field. Modern social media catalog style.
        
        [STYLE]:
        Handheld POV shot, 50mm lens, shallow depth of field, soft natural lighting, realistic skin tones, HDR, ultra detailed texture, cinematic product photography, clean minimal aesthetic, high-end Instagram/TikTok shop style, 8K ultra realistic.
        ${config.additionalPrompt ? `\n        [ADDITIONAL INSTRUCTION]: ${config.additionalPrompt}` : ''}
